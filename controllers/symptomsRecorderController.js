...
const recordSymptoms = async (req, res) => {
    try {
        ...
        let sympID = await PatientSymptomsDetail.create(newSymptom).then(result => {
            return result.Symptom_ID
        }); //inserting into Patient_Symptoms_Detail table
        let data = {
